...
# Evaluator base name; the container build timestamp is appended below to version it,
# per the schema (evaluation_summary_<evaluator_name>.csv).
evaluator_base = "Consistency_Point_Astrocyte"
...
# Raw predictions artifact base name (per schema): "{EVALUATOR_NAME}_predictions"
