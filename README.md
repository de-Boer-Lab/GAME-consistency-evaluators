...
## Development
These codebases serves as a templates for creating custom evaluators that follow a similar structure. The modular design makes it easy to adapt for different evaluation tasks.